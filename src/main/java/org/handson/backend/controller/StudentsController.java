package org.handson.backend.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.handson.backend.model.*;
import org.handson.backend.service.StudentService;
//import org.handson.backend.util.PaginationAndList;
...
import static org.handson.backend.util.FPS.FPSBuilder.aFPS;
import static org.handson.backend.util.FPSCondition.FPSConditionBuilder.aFPSCondition;
import static org.handson.backend.util.FPSField.FPSFieldBuilder.aFPSField;
import static org.handson.backend.util.Strings.likeLowerOrNull;
...
public class StudentsController {
    ...
    // פונקציית החיפוש המרכזית - היא זו שמטפלת ב-GET /api/students
    @GetMapping("")
